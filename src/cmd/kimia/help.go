...
func printHelp() {
	...
	fmt.Println("  --scan                                Scan the built image with RapidFort rfscan")
	fmt.Println("                                        Exports the merged rootfs (no docker/podman).")
	fmt.Println("                                        Requires the RapidFort CLI in the image")
	fmt.Println("                                        (build kimia with RF_APP_HOST set).")
	...
	fmt.Println()
	fmt.Println("  # Build nginx from Git and scan (no push, no docker/podman)")
	fmt.Println("  kimia --context=https://github.com/nginx/docker-nginx.git \\")
	fmt.Println("         --dockerfile=mainline/alpine/Dockerfile \\")
	fmt.Println("         --destination=mynginx \\")
	fmt.Println("         --no-push --scan")
	fmt.Println()
